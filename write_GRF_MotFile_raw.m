...
repoDir = [pwd,'\'] ;
addpath([repoDir, '\S001\S001_anc_files']);
...
freq_filtering_run = 2; % lpCutoffFreq for force and marker data
...
%% Write forces files
    ...
    if walking || treadmill % write out a per-foot Grf file
        ...
        input_file = strrep(infile, '.trc', ['_forces_filt' num2str(freq_filtering_run) 'Hz.mot']);
