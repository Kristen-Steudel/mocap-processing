...
modelProcessor.append(osim.ModOpAddExternalLoads('../ID/rotated_Sprint_04500001_external_forces.xml'))
...
table = osim.TimeSeriesTable('../IK/rotated_Sprint_04500001_ik.mot')
...
solution.getMocoSolution().write('rotated_Sprint_04500001_moco.sto')

# Generate a PDF with plots for the solution trajectory.
model = modelProcessor.process()
report = osim.report.Report(model,
                            'rotated_Sprint_04500001_moco.sto',
                            output='rotated_Sprint_04500001_moco.pdf',
                            bilateral=True)
