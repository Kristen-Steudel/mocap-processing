...
modelProcessor.append(ModOpAddExternalLoads('../ID/rotated_Sprint_07200001_external_forces.xml'));
...
inverse.set_final_time(0.7); % 3.175 Change this value 700*.005 (is half a gait cycle)

% Load the kinematics data source.
table = TimeSeriesTable('../IK/rotated_Sprint_07200001_ik.mot');
