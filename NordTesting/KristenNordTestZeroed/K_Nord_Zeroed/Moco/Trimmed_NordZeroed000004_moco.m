...
modelProcessor.append(ModOpAddExternalLoads('../ID/Trimmed_NordZeroed000004_external_forces.xml'));
...
inverse.set_initial_time(0.05);
inverse.set_final_time(9.4);

% Load the kinematics data source.
table = TimeSeriesTable('../IK/Trimmed_NordZeroed000004_ik.mot');
