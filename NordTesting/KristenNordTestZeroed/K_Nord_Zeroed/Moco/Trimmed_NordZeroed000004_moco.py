...
modelProcessor.append(osim.ModOpAddExternalLoads('../ID/Trimmed_NordZeroed000004_external_forces.xml'))
...
solution.getMocoSolution().write('Trimmed_NordZeroed000004_moco.sto')

# Generate a PDF with plots for the solution trajectory.
model = modelProcessor.process()
report = osim.report.Report(model,
                            'Trimmed_NordZeroed000004_moco.sto',
                            output='Trimmed_NordZeroed000004_moco.pdf',
                            bilateral=True)
